...
Pod::Spec.new do |s|
  s.name             = 'MathLibrary'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MathLibrary.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Mohd Imran/MathLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mohd Imran' => 'mohd.imran.3pg@gmail.com' }
  s.source           = { :git => 'https://github.com/Mohd Imran/MathLibrary.git', :tag => s.version.to_s }
